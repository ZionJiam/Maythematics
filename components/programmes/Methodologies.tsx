...
const data: AccordionItem[] = [
    ...
    { letter: 'H', title: 'Hone Hard Questions', content: 'We equip students with simple, step-by-step strategies that turn even the toughest math problems into manageable challenges.\n\nOur carefully structured worksheets expose students to a wide range of higher-order questions, helping them build confidence and achieve true mastery. Our teachers are trained to guide with probing questions instead of spoon-feeding, helping students learn how to spot the right methods and solve effectively for every problem.' },
    { letter: 'I', title: 'Individualized Learning', content: 'Every student is unique. That’s why we adapt our methods to suit different learning paces and styles. We also personalise quizzes to target students’ learning gaps on top of structured worksheets. We believe in working alongside with parent or student hand in hand where the other party can send us questions their child or he or she is weak in, then our teachers will retrieve or recreate a new quiz for them. With more than 500 customised quizzes (and counting) in our system, every student gets the focused practice they need to improve.' },
    ...
    return (
        <section id="shine" className={`${styles.section} sectionYPadding`}>
            ...
            <div data-aos="fade-up" className={styles.titleContainer}>
                <h3 className={`${styles.title} text-xl`}>How We Help Students SHINE</h3>
            </div>
