            ...
            <div className={styles.container}>
                ...
                <div className={`${styles.lessonContainer}`}>
                    ...
                    <div className={styles.textContainer}>
                        <div className={styles.textContent}>
                            <h2 data-aos="fade-up" className="text-xl">
                                Highly Effective<br/> Problem-Solving Strategies
                            </h2>
                            <div
                                data-aos="fade-up"
                                className={styles.descriptionContainer}
                    ...
                    <div className={styles.textContainer}>
                        <div className={styles.textContent}>
                            ...
                            >
                                ...
                                <p className={styles.description}>
                                    Our tutors crafts quizzes designed to target each child’s weak spots. Whether a tricky topic is flagged by parents or students, our team curates or creates customised quizzes to close the gap. With over 500 tailored quizzes in our system, no child is ever limited by a one-size-fits-all approach.
                                </p>
                            </div>
                        </div>
                    </div>
